...
$(document).ready(function () {
    ...
    $('#MoveFileWindow').click(function (e) {
        e.stopPropagation();
    });
    ...
    $("#SelectMoveDirectory").click(function (e) {
        ...
        $('#excludeDirectories').attr('value', $('.RowSelect').map(function () {
    ...
    $("#SubmitMoveFile").click(function (e) {
        ...
        var folders = $('#DirectoryTable > tbody > .RowSelect.Folder').map(function () {
            return this.id;
        }).get();
        var files = $('#DirectoryTable > tbody > .RowSelect').not('.Folder').map(function () {
            return this.id;
        }).get();
