...
<center>
	<button type="button" class="btn btn-lg btn-default" data-toggle="modal" data-target="#SignUp" style="width: 150px; margin-right: 40px;">Sign Up</button>
	<button type="button" class="btn btn-lg btn-default" data-toggle="modal" data-target="#Login" style="width: 150px; margin-left: 40px;">Login</button>
	<h3><?php echo $TPL['Users'];?> users registered so far. Totaling X bytes stored.</h3>
</center>
...
<div>
<?php require_once 'Application/Views/Snippets/CredentialWindows.php';?>